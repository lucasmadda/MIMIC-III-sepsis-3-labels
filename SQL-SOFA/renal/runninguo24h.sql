DROP MATERIALIZED VIEW IF EXISTS mimiciii_sofa.SOFA_runninguo24h CASCADE;
create materialized view mimiciii_sofa.SOFA_runninguo24h as
SELECT 
uo_1.hadm_id, uo_1.HLOS
, SUM(uo_4.UrineOutput)  as running_uo_24h
FROM mimiciii_sofa.SOFA_uoperhour uo_1
JOIN mimiciii_sofa.SOFA_uoperhour uo_4 ON
