DROP MATERIALIZED VIEW IF EXISTS mimiciii_sofa.SOFA_cardio CASCADE;
CREATE materialized VIEW mimiciii_sofa.SOFA_cardio AS
-- calculate weight
with wt as	(
	select ha.hadm_id
	-- average weight
...
, echo2 as (
	...
	from admissions ha
	left join mimiciii_sofa.echodata echo
